...
#define F_NAME_COM "/usr/local/geye/bin/pedestrian_detecter/person_comp.csv"	//file name (component)
#define F_NAME_ROOT "/usr/local/geye/bin/pedestrian_detecter/person_root.csv" //file name (root_filter)
#define F_NAME_PART	"/usr/local/geye/bin/pedestrian_detecter/person_part.csv" //file name (part_filter)
