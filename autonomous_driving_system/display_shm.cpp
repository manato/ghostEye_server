...
main(int argc, char *argv[]) {
    ...
    key_t shm_key, shm_key_height, shm_key_width, shm_key_size;
    int shrd_id, shrd_id_height, shrd_id_width, shrd_id_size;
